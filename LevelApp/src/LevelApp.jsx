...
function BottomNav({ active, onNav }) {
  const items = [
    { key: "sakahan", icon: "🚜", label: "Sakahan" },
...
function GastosScreen({ expenses, onLog, onDelete }) {
  ...
  return (
    <div className="screen-body gastos-screen-layout">
      {/* Hindi kasama sa scroll – naka-stay sa taas */}
      <div className="gastos-header" style={{ flexShrink: 0 }}>
        {/* 1. Kabuuang gastos – right side */}
        ...
        {/* 2. Button – pareho ng laki sa SAKAHAN */}
        <ActionBtn variant="olive" onClick={onLog}>📝&nbsp;Maglista ng Gastos</ActionBtn>
      ...
      {/* Scrollable lang – mga nakalista dito */}
        ...
        {expenses.length === 0 ? (
          <div style={{
            ...
            <span style={{ fontSize: 14, textAlign: "center", lineHeight: 1.6 }}>
              Wala pang nakalista— pindutin ang "Maglista ng Gastos" para magsimula.
            </span>
          </div>
        ) : (
  ...
  return (
    <>
      <div style={{
        ...
        {/* Kaliwa: litrato (user photo) o emoji */}
        <div style={{
        ...
        {/* Kanan: presyo – mas malaki + label sa ibaba */}
